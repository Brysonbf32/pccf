...
<body>
  ...
  <main id="main">
    ...
    <!-- ======= Breadcrumbs ======= -->
    <div class="breadcrumbs d-flex align-items-center" style="background-image: url('assets/img/imagebackabout.jpeg');">
        ...
        <div class="row gy-4">
          <div class="col-lg-6">
            <div class="info-item  d-flex flex-column justify-content-center align-items-center">
              <i class="bi bi-map"></i>
              <h3>Notre Address</h3>
              <p>Avenue Kalehe, Quartier Mulongwe
                  , Uvira Ville, RDC</p>
            </div>
          </div><!-- End Info Item -->
          ...
          <div class="col-lg-3 col-md-6">
            <div class="info-item d-flex flex-column justify-content-center align-items-center">
              ...
              <h3>Notre Email</h3>
              <p><a href="mailto:peacechangachangafoudation1@gmail.com" >Peacechangachangafoudation1@gmail.com</a> </p>
            </div>
          </div><!-- End Info Item -->
          ...
          <div class="col-lg-3 col-md-6">
            <div class="info-item  d-flex flex-column justify-content-center align-items-center">
              ...
              <p><a href="tel:+243 972584021">+243 972584021</a>,<a href="tel:+243 853008390">+243 853008390</a></p>
              <p></p>
            </div>
          </div><!-- End Info Item -->
