                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="example" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                        <tr>
                                            <td><img class="imagetable rounded-sm" src="../assets/img/blog/<?=$imageblog?>"></td>
                                            <td><?=$titreblog?></td>
                                            <td>
                                            <a class="p-2"  data-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">
                                            ...
                                            <a class="p-2"  data-toggle="modal" data-target="#suprim<?=$idblog?>">
                                                            ...
                                                            <form method="POST" enctype="multipart/form-data">
                                                                <div class="row">
                                                                    <div class="col-12 col-lg-6">
                                                                        ...
                                                                        <input type="file" class="modal_input" name="input_image" value="<?=$imageblog?>">
                                                                    </div>
                                                                    <div class="col-12 col-lg-6">
                                                ...
                                                <div class="modal fade bd-example-modal-sm" id="suprim<?=$idblog?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form method="POST">
                                                                <h2 class="modal_suprimtitre">Veux-tu suprimer l'utilisateur <span class="span_nomutil"><?=$titreblog?></span></h2>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modaltitle" id="exampleModalLabel">Blog</h5>
                    <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
